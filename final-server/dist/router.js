...
router.get('/posts', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allRecords;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, model.fetch(postCollection)];
            case 1:
                allRecords = _a.sent();
                res.status(200).json({
                    data: allRecords,
...
router.get('/posts/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, record, err_6;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.get(postCollection, id)];
            case 2:
                record = _b.sent();
                res.status(200).json({
                    data: record,
...
router.get('/posts/filter/:filter', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var query, records, err_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = JSON.parse(req.params.filter);
                if (query._id) {
                    query._id = new mongodb_1.ObjectID(query._id);
                }
                return [4, model.fetch(postCollection, query)];
            case 1:
                records = _a.sent();
                res.status(200).json({
                    data: records,
...
router.post('/posts', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var putData, record, err_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                putData = req.body;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, model.put(postCollection, putData)];
            case 2:
                record = _a.sent();
                res.status(200).json({
                    data: record.ops[0],
...
router.patch('/posts', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var updateDate, record, err_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateDate = req.body;
            ...
            case 1:
                _a.trys.push([1, 5, , 6]);
                if (!updateDate._id) return [3, 3];
                return [4, model.patch(postCollection, updateDate)];
            case 2:
                record = _a.sent();
                res.sendStatus(200).json({
                    data: record,
...
router.delete('/posts/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var delId, err_10;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.del(postCollection, delId)];
            case 2:
                _b.sent();
                res.sendStatus(200).json({
                    msg: "Delete success!"
...
router.get('/articles', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allRecords;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, model.fetch(articleCollection)];
            case 1:
                allRecords = _a.sent();
                res.status(200).json({
                    data: allRecords,
...
router.post('/articles', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var articleData, record, err_16;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                if (articleData.userId) {
                    articleData.userId = new mongodb_1.ObjectID(articleData.userId);
                }
                return [4, model.put(articleCollection, articleData)];
            case 2:
                record = _a.sent();
                res.status(200).json({
                    data: record.ops[0],
...
router.patch('/articles', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var updateDate, record, err_17;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateDate = req.body;
            ...
            case 1:
                ...
                return [4, model.patch(articleCollection, updateDate)];
            case 2:
                record = _a.sent();
                res.status(200).json({
                    data: record,
...
router.delete('/articles/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var delId, err_18;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.del(articleCollection, delId)];
            case 2:
                _b.sent();
                res.status(200).json({
                    msg: "Delete success!"
...
router.get('/articles/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var searchId, record, err_19;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.get(articleCollection, searchId)];
            case 2:
                record = _b.sent();
                res.status(200).json({
                    data: record,
...
router.get('/articles/user/:userid', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userid, records, err_20;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.getUserDatas(articleCollection, userid)];
            case 2:
                records = _b.sent();
                res.status(200).json({
                    data: records,
...
var petServiceCollection = 'PetService';
router.get('/pet-services', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allRecords;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, model.fetch(petServiceCollection)];
            case 1:
                allRecords = _a.sent();
                res.status(200).json({
                    data: allRecords,
...
router.post('/pet-services', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var putServiceData, record, err_21;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                putServiceData = req.body;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                if (putServiceData.userId) {
                    putServiceData.userId = new mongodb_1.ObjectID(putServiceData.userId);
                }
                return [4, model.put(petServiceCollection, putServiceData)];
            case 2:
                record = _a.sent();
                res.status(200).json({
                    data: record.ops[0],
...
router.patch('/pet-services', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var updateDate, record, err_22;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateDate = req.body;
            ...
            case 1:
                ...
                return [4, model.patch(petServiceCollection, updateDate)];
            case 2:
                record = _a.sent();
                res.status(200).json({
                    data: record,
...
router.delete('/pet-services/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var delId, err_23;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.del(petServiceCollection, delId)];
            case 2:
                _b.sent();
                res.status(200).json({
                    msg: "Delete success!"
...
router.get('/pet-services/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var searchId, record, err_24;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.get(petServiceCollection, searchId)];
            case 2:
                record = _b.sent();
                res.status(200).json({
                    data: record,
...
router.get('/pet-services/user/:userid', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userid, records, err_25;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, model.getUserDatas(petServiceCollection, userid)];
            case 2:
                records = _b.sent();
                res.status(200).json({
                    data: records,
